...
class TestimonialsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create testimonial" do
    assert_difference('Testimonial.count') do
      post testimonials_url, params: { testimonial: { instagram: @testimonial.instagram, name: @testimonial.name, photo: @testimonial.photo, position: @testimonial.position, status: @testimonial.status, text: @testimonial.text } }
    end
  ...
  test "should update testimonial" do
    patch testimonial_url(@testimonial), params: { testimonial: { instagram: @testimonial.instagram, name: @testimonial.name, photo: @testimonial.photo, position: @testimonial.position, status: @testimonial.status, text: @testimonial.text } }
