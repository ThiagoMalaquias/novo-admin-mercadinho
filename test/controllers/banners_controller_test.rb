...
class BannersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create banner" do
    assert_difference('Banner.count') do
      post banners_url, params: { banner: { end_date: @banner.end_date, image: @banner.image, image_mobile: @banner.image_mobile, start_date: @banner.start_date, status: @banner.status, title: @banner.title, url: @banner.url } }
    end
  ...
  test "should update banner" do
    patch banner_url(@banner), params: { banner: { end_date: @banner.end_date, image: @banner.image, image_mobile: @banner.image_mobile, start_date: @banner.start_date, status: @banner.status, title: @banner.title, url: @banner.url } }
