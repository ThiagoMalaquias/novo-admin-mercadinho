...
class FaqsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create faq" do
    assert_difference('Faq.count') do
      post faqs_url, params: { faq: { question: @faq.question, reply: @faq.reply, status: @faq.status } }
    end
  ...
  test "should update faq" do
    patch faq_url(@faq), params: { faq: { question: @faq.question, reply: @faq.reply, status: @faq.status } }
